...
const PqrsScreen = () => {
    ...
    const [dateRadicado, setDateRadicado] = useState(null);
    const [timeRadicado, setTimeRadicado] = useState(null);
                ...
                <View style={[stylesPqrsScreen.container, { height: screenHeight - 100 }]}>
                    <View style={stylesPqrsScreen.subContainer}>
                        ...
                        <View style={{ flexDirection: 'row', marginBottom: 16, width: "40%", alignSelf: 'flex-end', }}>
                            ...
                            <TouchableOpacity
                                style={[{ flex: 1, padding: 12, alignItems: 'center', borderBottomColor: "#ddd", borderBottomWidth: 2 }, selectedTab === "newPqrs" && { borderBottomColor: "#90D400", backgroundColor: "#90D400", borderTopLeftRadius: 15, borderTopRightRadius: 15 }]}
