                        ...
                        <View>
                            <View style={{ marginTop: 50 }}>
                                <Text style={stylesViewOperatorsModal.textModalGray}>
                                    ...
                                    <Text style={stylesViewOperatorsModal.textModalGreen}>{operator.nombreEmpresa}</Text>
                                    {" "}a descontar el saldo insoluto de este préstamo de mis prestaciones socuales el momento de registrarse la terminación de mi contrato de trabajo por cualquier causal.
                                </Text>
                            </View>
                            <View style={{ marginTop: 20 }}>
                                <Text style={stylesViewOperatorsModal.textModalGray}>
